...
$faq=[
  ...
  [
    ...
    "answer" => "Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:",
      "first" => ["title"=>"La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:",
      ...
      "second"=>["title"=>"La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali."],
...
<html lang="en">
  ...
  <body>
    ...
    <?php if (array_key_exists("first",$value) ) { ?> 
      <p>
        <ol>
          <li>
            <?php echo $value["first"]["title"]?>
            <ol type="a">
              <li>
              <?php echo $value["first"]["a"]?>
              </li>
              <li>
              <?php echo $value["first"]["b"]?>
              </li>
            </ol>
          </li>
          <li><?php echo $value["second"]["title"]?></li>
        </ol>
        <?php echo $value["text"]?>
      </p>
